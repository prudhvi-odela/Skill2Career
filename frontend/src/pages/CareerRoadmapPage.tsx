              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '10px' }}>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <button
                      className="btn"
                      style={{ padding: '4px 8px', fontSize: '0.7rem', background: 'rgba(255, 255, 255, 0.05)' }}
                      onClick={() => handleFeedback(r.skill_id, 'HELPFUL')}
                      title="Helpful recommendation"
                    >
                      <ThumbsUp size={12} /> {feedbackSuccess[r.skill_id] === 'HELPFUL' ? '✓' : ''}
                    </button>
                    <button
                      className="btn"
                      style={{ padding: '4px 8px', fontSize: '0.7rem', background: 'rgba(255, 255, 255, 0.05)' }}
                    ...
                    >
                      Why this Skill? {isExpanded ? <ChevronUp size={12} /> : <ChevronDown size={12} />}
                    </button>
                  </div>
                </div>
                ...
                {/* Expanded Rationale */}
                {isExpanded && (
                  <div style={{ marginTop: '12px', paddingTop: '12px', borderTop: '1px solid rgba(255, 255, 255, 0.05)', fontSize: '0.8rem', color: '#cbd5e1' }}>
